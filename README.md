...
[![Database](https://img.shields.io/badge/Storage-PostgreSQL%20%2F%20SQLite-blue.svg)](https://www.postgresql.org/)
...
**A high-performance, modular Open-Source Real Estate Marketplace and PropTech engine engineered with Django 5.x, Django REST Framework (DRF), Geo-Spatial Querying, Leaflet Map Search, Broker CRM, and instant WhatsApp Lead Conversion.**

[Key Features](#-key-features) • [Architecture](#-architecture) • [Quick Start](#-quick-start) • [Mobile REST API](#-mobile-app-rest-api) • [CLI Guide](#-cli-usage-guide) • [Author](#-author)
...
| :--- | :--- | :--- |
| 🗺️ **Interactive Geo-Spatial Map Search** | Leaflet.js + GeoJSON FeatureCollections | Real-time map bounding box search, custom floating price badges, and pin clustering. |
...
| 🌐 **Bilingual (Arabic RTL & English LTR)** | Native I18N + Tailwind CSS / Vanilla CSS | 100% localized layout supporting regional terminology, right-to-left layout, and multi-currencies. |
...
| 🧙 **Multi-Step Listing Wizard** | Client-side Interactive Map Pin Placement | Self-service listing creation with drag-and-drop geographical coordinate picker. |
| ⚡ **Sub-Second Spatial Filtering** | Index-Optimized Queries + WAL Mode | Low-latency response times for complex multi-criteria filters (Purpose, Type, Beds, Price). |
...
flowchart TD
    ...
    subgraph Storage_Layer ["4. Persistence & Database"]
        ...
        MediaCDN[("Media Storage / CDN<br/>(Photos & Blueprints)")]
    end
...
Open [**http://127.0.0.1:8097**](http://127.0.0.1:8097) to browse the interactive portal.
...
| `GET` | `/api/v1/properties/{id}/` | Full property details with gallery and specs |
...
* 🛡️ **Test Coverage**: **100% pass rate** across models, DRF serializers, filters, and leads.
